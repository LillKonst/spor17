...
export default function Contact() {
  return (
    <div className="bg-white rounded w-full md:p-10 flex flex-col lg:flex-row gap-5">
      
      <div className="flex-1 md:p-10 flex flex-col gap-5">
        <h1 className="text-2xl mb-3">Kontakt oss</h1>
        ...
        <div className="rounded-xl overflow-hidden max-w-[400px] self-center">
