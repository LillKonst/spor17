...
export default function InfoBoxHome() {
  return (
    <div className="bg-white p-10 my-10 rounded-lg flex flex-col gap-5 md:flex-row w-full px-12">
      <div className="flex flex-row gap-3 md:gap-5 flex-1 ps-12">
        <img src={WriteCardDisplay} alt="2 pakker med kort" className="rounded-lg"/>
      </div>
     
      <div className="flex-1 flex flex-col justify-center text-center lg:text-left xl:mx-10 pe-12">
      ...
      <h5 className="text-custom green mb-4">ps: Kortene er designet og produsert i Norge!</h5>
      <button className="bg-customGreen">Våre Julekort</button>
      </div>
    </div>
  );
}