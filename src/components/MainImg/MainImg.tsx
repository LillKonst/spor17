...
export default function MainImg() {
  ...
  return (
    <div className="w-full lg:px-12 flex flex-col md:flex-row mb-5 md:h-[500px] xl:max-h-[500px] lg:rounded">
      ...
      <div className="bg-customBlue p-5 sm:p-10 flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-10 md:h-full md:w-1/2 2xl:w-2/5">
        <h1 className="text-3xl sm:text-5xl text-center lg:text-5xl xl:text-7xl leading-none tracking-tight">Små kort. Store øyeblikk.</h1>
        <CTAButton
          label="Handle nå"
          onClick={() =>
