export default function Footer() {
  return(
    <div className="flex flex-col gap-5 items-center pt-10 pb-3 px-5 w-full">
      ...
      <div>
        <h2 className="md:text-xl mb-1">Informasjon</h2>
        <h3 className="text-sm md:text-md">ORG NR: 916851383</h3>
        <h3 className="text-sm md:text-md">Nygata 11, 3189 Horten</h3>
        <h3 className="text-sm md:text-md">Nettside utviklet av Lill-Kristine Konst</h3>
      </div>

      <div>
        <h2 className="md:text-xl mb-1">Følg oss</h2>
      ...
      <div className="">
        <p className="text-sm">© alle rettigheter reservert SPOR 17</p>
      </div>
