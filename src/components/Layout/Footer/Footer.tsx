export default function Footer() {
  return(
    <div className="flex flex-col gap-5 items-center pt-10 pb-3 px-5 w-full">
      ...
      <div>
        <h2 className="text-xl mb-1">Kundeservice</h2>
        <h3>kontakt oss - post@spor17.no</h3>
        <h3>Frakt og retur</h3>
        <h3>Salgsbetingelser</h3>
      </div>

      <div>
        <h2 className="text-xl mb-1">Informasjon</h2>
        <h3>ORG NR: 916851383</h3>
        <h3>Nygata 11, 3189 Horten</h3>
        <h3>Nettside utviklet av Lill-Kristine Konst</h3>
      </div>

      <div>
        <h2 className="text-xl mb-1">Følg oss</h2>
      ...
      <div className="">
        <p>© alle rettigheter reservert SPOR 17</p>
      </div>
